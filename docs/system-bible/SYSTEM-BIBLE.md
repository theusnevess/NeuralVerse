...
> Generated consolidation of 36 individual system bible chapter documents.
> Generated: 2026-07-15
> Authority: non-canonical implementation snapshot. Owner-approved authority documents and governed Obsidian records remain canonical.

---

## Table of Contents

- [Executive Summary](#chapter-00)
- [Project Vision](#chapter-01)
- [02-ui-constitution](#chapter-02)
- [System Architecture](#chapter-03)
- [03-architecture-guide](#chapter-04)
- [Frontend Architecture](#chapter-05)
- [Navigation and Routing](#chapter-06)
- [Curriculum Architecture](#chapter-07)
- [Learning Experience](#chapter-08)
- [Workspace Architecture](#chapter-09)
- [Search System](#chapter-10)
- [Retrieval System](#chapter-11)
- [Atlas System](#chapter-12)
- [Didactic Agent Runtime](#chapter-13)
- [Agent A1: Didactic Architecture](#chapter-14)
- [Agent A2: Curriculum & Dependency](#chapter-15)
- [Agent A3: Visual & Interactive Media](#chapter-16)
- [Agent A4: Code, Simulation & Laboratory](#chapter-17)
- [Agent A5: Research & State-of-the-Art](#chapter-18)
- [Agent A6: Application & Professional Transfer](#chapter-19)
- [Agent A7: Assessment & Reinforcement](#chapter-20)
- [Agent A8: Obsidian & Knowledge Governance](#chapter-21)
- [Agent A9: Storytelling & Learning Journey](#chapter-22)
- [Agent A10: Curiosity & Engagement](#chapter-23)
- [Personalization System](#chapter-24)
- [Study Sessions](#chapter-25)
- [UI Design Language](#chapter-26)
- [Accessibility](#chapter-27)
- [Security Model](#chapter-28)
- [Governance Model](#chapter-29)
- [Testing and Certification](#chapter-30)
- [Current Capabilities](#chapter-31)
- [Known Limitations](#chapter-32)
- [Development Guidelines](#chapter-33)
- [Glossary](#chapter-34)
- [NV-2900: Canonical Repository Cleanup & Experimental Content Purge](#chapter-35)
...
No educational content should be implemented before the interface foundation is completed.
...
3. Deep Focus
4. Long-Term Readability
5. Scientific Professionalism
...
"I am inside a modern AI research laboratory."
...
* Subtle space-inspired elements.
* Premium appearance.
...
The platform should reduce cognitive load and maximize learning efficiency.
...
Define the architectural rules of NeuralVerse.
...
All UI elements must be component-based.
...
- All Playwright test specifications and configurations
...
- Governance documentation
- Test reference screenshots
- System Bible chapter files, README.md, and this generated non-canonical snapshot

## Canonical Source Documents Removed

Five `docs/sources/` placeholders were audited and classified `DELETE_REPRODUCIBLE`. Four have direct chapter equivalents; the tooling placeholder has distributed coverage across existing chapters. No unique authority or validation evidence was lost. Canonical authority remains outside this generated snapshot.
...
| Broken documentation links | PASS — 0 broken links after removing references to deleted screenshots |
...
| Accessibility reconciliation | DEFERRED — direct review postponed |
| Manual route review | DEFERRED — headed review postponed |
...
Static cleanup and automated validation gates passed. The generated System Bible is a non-canonical implementation snapshot. Direct headed route review and Obsidian synchronization are deferred follow-up work.
...
- `02-ui-constitution.md`: Fixed navigation priorities to match implementation
