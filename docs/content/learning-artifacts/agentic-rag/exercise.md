...
Outline state transitions for query revision loops.

### learner task

Draw a flowchart or describe the state transitions of a Self-RAG agent that detects if retrieved documents are irrelevant and decides to rewrite the search query.
