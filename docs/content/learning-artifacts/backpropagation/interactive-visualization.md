...
Specify a backward derivative multiplier graph.

### explanation

This specification describes a backpropagation graph explorer. The user modifies output loss, and the tool highlights derivatives along edges in red, showing how partial derivatives multiply back through the network.
