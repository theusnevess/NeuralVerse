---
artifact_id: "artifact-unet-vs-maskrcnn-interactive-visualization"
artifact_title: "Mask Generation Flow Spec"
...
# Mask Generation Flow Spec

## Artifact Summary

Specifies an interactive tool for exploring Mask Generation Flow Spec — describes the controls, visual feedback, and conceptual relationships a learner would manipulate to understand U-Net vs Mask R-CNN (Conceptual Comparison).

## Required Contract Fields

### objective

Specify a dynamic chart tracing mask processing paths in U-Net and Mask R-CNN.

### explanation

This specification outlines a workflow comparison player. The user switches between 'U-Net' (showing continuous pixel map flows) and 'Mask R-CNN' (showing box predictions followed by individual internal mask expansions).
