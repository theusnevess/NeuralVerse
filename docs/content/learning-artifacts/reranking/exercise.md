...
# Analyzing Reranking Scalability
...
Calculate computational latency differences in single-stage vs. two-stage search.

### learner task

Explain why we cannot use a Cross-Encoder directly as the initial retrieval engine for a database of 10 million documents, focusing on computation and latency.
