...
Specify a saddle-point optimizer comparison path.

### explanation

This specification describes an optimizer race simulator. The user runs SGD, Momentum, and Adam parameters simultaneously on a saddle-point loss landscape to watch which optimizer escapes local minima first.
