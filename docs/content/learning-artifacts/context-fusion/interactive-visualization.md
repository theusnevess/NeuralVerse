...
# RRF Rank Fusion Calculator Spec
...
Specify a interactive rank-dragging table displaying output scores updating.

### explanation

This specification outlines a reciprocal rank fusion calculator. The user moves items in two input rank columns, watching their combined RRF scores calculate and update a fused output column in real time.
