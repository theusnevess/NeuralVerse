...
Specify a sinusoidal matrix graph.

### explanation

This specification describes a sinusoidal wave grid. The user inputs sequence lengths and watches a 2D heatmap plot showing the alternating patterns of sine and cosine components across the embedding dimensions.
