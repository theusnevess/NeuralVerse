...
# River Channels and Irrigation Locks
...
Provide an analogy based on flow channels directing outputs.

### explanation

A base model is like a wild river that flows along the path of least resistance (completing text based on statistical frequency). Instruction tuning is like building channels and locks along the river, directing the water flow to run precisely where we want it to go (responding directly to instructions).
