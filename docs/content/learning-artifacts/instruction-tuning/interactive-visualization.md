...
This specification outlines an instruction-response alignment mapper. The user inputs prompts and toggles between a 'Base Model' completion path (generating statistical continuation loops) and an 'Aligned Model' path (responding directly).
