...
# Visual Cross-Attention Mapping
...
Analyze attention score variations during token generations.

### learner task

Describe the role of cross-attention in an image captioning decoder, explaining how it connects generated word tokens to visual patches in the input image.
