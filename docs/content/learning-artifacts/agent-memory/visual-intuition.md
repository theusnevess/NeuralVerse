...
# Desk Notepads vs. Office Filing Cabinets
...
Provide an analogy based on desktop workspaces vs warehouse files.

### explanation

Short-term memory is like the notepad on your desk where you write down active phone numbers and coordinates during a call. Long-term memory is like the filing cabinet in the corner of the office: you can't fit it on your desk, but when you need a contract from three years ago, you walk over, find it, and bring it back to your desk.
