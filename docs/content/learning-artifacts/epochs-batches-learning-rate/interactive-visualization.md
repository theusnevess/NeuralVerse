...
Specify interactive loss path simulation curves.

### explanation

This specification outlines a learning rate scheduler simulator. The user slides learning rate from 0.0001 to 1.0. The tool simulates training loss curves, showing noisy oscillation, divergence, or slow flatlines.
