...
# Attention Map Re-Alignments Spec
...
Specify an attention map overlay showing weight shifts toward few-shot matches.

### explanation

This specification describes an activation map explorer. The user adds few-shot examples and watches mock attention weights reorganize to align the query token with target examples.
