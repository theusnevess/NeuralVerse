...
Contrast coordinate setups and pixel-dense mappings.

### learner task

Differentiate between Image Classification, Object Detection, and Semantic Segmentation in terms of input-output mappings and coordinate requirements.
