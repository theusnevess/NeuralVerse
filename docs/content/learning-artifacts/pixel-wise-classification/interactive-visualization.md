...
Specifies an interactive tool for exploring Logit Inspector Tool Spec — describes the controls, visual feedback, and conceptual relationships a learner would manipulate to understand Pixel-wise Classification.
