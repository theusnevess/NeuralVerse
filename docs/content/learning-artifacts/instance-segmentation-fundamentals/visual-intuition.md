...
# Puzzle Piece Unique Identifiers
...
Provide an analogy based on unique puzzle ID tags.

### explanation

Imagine a puzzle where every piece has a unique ID number. If you have five apples on a table, instance segmentation doesn't just color them all red; it labels them 'Apple #1', 'Apple #2', up to 'Apple #5', drawing a tight custom border around each apple separately.
