---
artifact_id: "artifact-instance-segmentation-fundamentals-interactive-visualization"
artifact_title: "Overlap Hover Inspector Spec"
...
# Overlap Hover Inspector Spec

## Artifact Summary

Specifies an interactive tool for exploring Overlap Hover Inspector Spec — describes the controls, visual feedback, and conceptual relationships a learner would manipulate to understand Instance Segmentation Fundamentals.

## Required Contract Fields

### objective

Specify a color overlay that distinguishes individual overlapping shapes.

### explanation

This specification describes an instance separation tool. The user hovers over a cluster of overlapping items to see them highlight individually with distinct colors and unique instance ID labels.
