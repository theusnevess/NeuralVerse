...
# RAG vs. Fine-Tuning Trade-off Spec
...
Specify a coordinate mapping widget showing recommendation shifts.

### explanation

This specification outlines a RAG vs. Fine-Tuning trade-off matrix. The user slides controls for 'Factual Update Frequency' and 'Domain Jargon Frequency' to see a recommendation point shift along a coordinate map.
