...
Specify a function and derivative curve graph plotter.

### explanation

This specification outlines a function plotter. The user selects Sigmoid, Tanh, ReLU, or Softmax from a dropdown, and the tool plots the function curve and its derivative, highlighting saturation regions where gradients vanish.
