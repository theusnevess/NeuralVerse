...
Specify a collapsible execution tree node hierarchy.

### explanation

This specification outlines a sub-goal tree builder. The user inputs a complex task and watches the agent node split into sub-nodes, with color-coded checkmarks indicating execution progression.
