...
Provide an analogy based on step-by-step assembly milestones.

### explanation

Imagine you are building a wooden desk. If you try to build it all at once without planning, you might end up with missing parts. Instead, you break down the project: first, gather tools; second, sand the wood; third, assemble the frame; fourth, varnish. You check off each sub-goal one-by-one to complete the desk successfully.
