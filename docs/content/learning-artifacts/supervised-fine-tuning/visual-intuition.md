...
Provide an analogy based on textbooks vs broad library readings.

### explanation

SFT is like a student attending a specialized boot camp. Instead of browsing random books in a library (pre-training), they sit down with a curated textbook of questions and answers. They study the format of these answers, practicing how to replicate the style and structure of expert explanations.
