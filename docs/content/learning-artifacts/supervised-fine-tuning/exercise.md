...
# Prompt Token Loss Masking Role
...
Evaluate gradient updates when prompts are masked vs updated.

### learner task

Why are the prompt tokens masked from the loss computation during SFT training, and what would happen if they were not masked?
