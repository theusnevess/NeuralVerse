...
# Compiler Critique Routing Board Spec
...
Specify a dynamic error node route returning corrected syntax blocks.

### explanation

This specification describes a self-correction loop tracker. The user starts a task, watching a code compiler error get captured by the critique node and fed back to the generator, which outputs a corrected code block.
