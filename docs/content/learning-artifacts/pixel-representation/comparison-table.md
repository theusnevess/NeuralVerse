---
artifact_id: "artifact-pixel-representation-comparison-table"
artifact_title: "Grayscale vs. Binary Matrix Mappings"
...
# Grayscale vs. Binary Matrix Mappings
...
Compare grayscale and binary images across range, representation, and applications.

### explanation

| Aspect | Grayscale Image | Binary Image |
|---|---|---|
| Matrix Elements | Values between 0 and 255 | Values of 0 (black) and 1 (white) |
| Precision | 8-bit integers (typical) | 1-bit boolean |
| Example AI Use Case | General feature extraction, OCR | Document binarization, mask segmentation |
