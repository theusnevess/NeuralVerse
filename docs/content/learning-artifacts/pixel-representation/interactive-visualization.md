...
Specify a magnified inspector overlay displaying raw numerical intensities.

### explanation

This specification describes a pixel magnifier playground. The user hovers over a small grayscale image, and a panel displays a zoomed-in grid of pixel blocks, overlaying the raw numerical value (0-255) on top of each corresponding block.
