---
lesson_id: "lesson-tool-calling"
lesson_title: "Tool Calling and External Actions"
canonical_status: "Draft"
topic: "Tool Calling and External Actions"
artifact_ids:
...
# Tool Calling and External Actions — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Tool Calling and External Actions.
...
After completing this lesson flow, the learner should understand the core concepts of Tool Calling and External Actions and be able to reason about their practical use in agentic computing systems and tool-execution loops.

## 3. Covered Concepts

*   High-level foundations of Tool Calling and External Actions;
