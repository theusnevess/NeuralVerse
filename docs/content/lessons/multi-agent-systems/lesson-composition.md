---
lesson_id: "lesson-multi-agent-systems"
lesson_title: "Multi-Agent Systems"
canonical_status: "Draft"
topic: "Multi-Agent Systems"
artifact_ids:
  - artifact-multi-agent-systems-explanatory-text
  - artifact-multi-agent-systems-visual-intuition
  - artifact-multi-agent-systems-interactive-visualization
  - artifact-multi-agent-systems-exercise
  - artifact-multi-agent-systems-comparison-table
---

# Multi-Agent Systems — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Multi-Agent Systems.
...
After completing this lesson flow, the learner should understand the core concepts of Multi-Agent Systems and be able to reason about their practical use in agentic computing systems and tool-execution loops.

## 3. Covered Concepts

*   High-level foundations of Multi-Agent Systems;
