---
lesson_id: "lesson-forward-propagation"
lesson_title: "Forward Propagation"
canonical_status: "Draft"
topic: "Forward Propagation"
artifact_ids:
  - artifact-forward-propagation-explanatory-text
  - artifact-forward-propagation-visual-intuition
  - artifact-forward-propagation-interactive-visualization
  - artifact-forward-propagation-exercise
  - artifact-forward-propagation-comparison-table---

# Forward Propagation — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Forward Propagation.
...
After completing this lesson flow, the learner should understand the core concepts of Forward Propagation and be able to reason about their practical use in deep AI architectures.

## 3. Covered Concepts

*   High-level foundations of Forward Propagation;
