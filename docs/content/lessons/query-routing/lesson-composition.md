---
lesson_id: "lesson-query-routing"
lesson_title: "Query Routing and Intent Detection"
canonical_status: "Draft"
topic: "Query Routing and Intent Detection"
artifact_ids:
...
# Query Routing and Intent Detection — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Query Routing and Intent Detection.
...
After completing this lesson flow, the learner should understand the core concepts of Query Routing and Intent Detection and be able to reason about their practical use in advanced retrieval systems and context fusion pipelines.

## 3. Covered Concepts

*   High-level foundations of Query Routing and Intent Detection;
