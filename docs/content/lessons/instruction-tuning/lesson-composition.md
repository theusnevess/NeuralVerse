---
lesson_id: "lesson-instruction-tuning"
lesson_title: "Instruction Tuning"
...
# Instruction Tuning — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Instruction Tuning.
...
After completing this lesson flow, the learner should understand the core concepts of Instruction Tuning and be able to reason about their practical use in model fine-tuning and adaptation pipelines.

## 3. Covered Concepts

*   High-level foundations of Instruction Tuning;
