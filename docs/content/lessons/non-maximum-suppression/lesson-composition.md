---
lesson_id: "lesson-non-maximum-suppression"
lesson_title: "Non-Maximum Suppression (NMS)"
...
# Non-Maximum Suppression (NMS) — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Non-Maximum Suppression (NMS).
...
After completing this lesson flow, the learner should understand the core concepts of Non-Maximum Suppression (NMS) and be able to reason about their practical use in object detection pipelines.

## 3. Covered Concepts

*   High-level foundations of Non-Maximum Suppression (NMS);
