---
lesson_id: "lesson-activation-functions"
lesson_title: "Activation Functions"
canonical_status: "Draft"
topic: "Activation Functions"
artifact_ids:
  - artifact-activation-functions-explanatory-text
  - artifact-activation-functions-visual-intuition
  - artifact-activation-functions-interactive-visualization
  - artifact-activation-functions-exercise
  - artifact-activation-functions-comparison-table---

# Activation Functions — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Activation Functions.
...
After completing this lesson flow, the learner should understand the core concepts of Activation Functions and be able to reason about their practical use in deep AI architectures.

## 3. Covered Concepts

*   High-level foundations of Activation Functions;
