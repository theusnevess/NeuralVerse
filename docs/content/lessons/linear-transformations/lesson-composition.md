---
lesson_id: "lesson-linear-transformations"
lesson_title: "Linear Transformations"
canonical_status: "Draft"
topic: "Linear Transformations"
artifact_ids:
  - artifact-linear-transformations-explanatory-text
  - artifact-linear-transformations-visual-intuition
  - artifact-linear-transformations-interactive-visualization
  - artifact-linear-transformations-exercise
  - artifact-linear-transformations-comparison-table---

# Linear Transformations — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Linear Transformations.
...
After completing this lesson flow, the learner should understand the core concepts of Linear Transformations and be able to reason about their practical use in AI engineering systems.

## 3. Covered Concepts

*   High-level foundations of Linear Transformations;
