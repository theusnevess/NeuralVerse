...
# Constitutional AI — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Constitutional AI.
...
After completing this lesson flow, the learner should understand the core concepts of Constitutional AI and be able to reason about its use in scalable alignment, rule-based oversight, and self-improving AI systems.

## 3. Covered Concepts

*   High-level foundations of Constitutional AI;
*   Constitutional principles and harmlessness categories;
*   Self-critique and revision mechanisms;
*   RLCAI and comparison with RLHF;
*   Value specification vs. value learning;
*   Red-teaming via constitutional critique.

## 4. Artifact Composition

### 4.1 Explanatory Text

Artifact: `artifact-constitutional-ai-explanatory-text`
Role: Introduces the core vocabulary, defining terminology and parameters.

### 4.2 Visual Intuition

Artifact: `artifact-constitutional-ai-visual-intuition`
Role: Provides a spatial analogy or visualization to build a strong mental model.

### 4.3 Interactive Visualization

Artifact: `artifact-constitutional-ai-interactive-visualization`
Role: Outlines an interactive spec where variables can be adjusted.

### 4.4 Exercise

Artifact: `artifact-constitutional-ai-exercise`
Role: Practice reasoning about principles or boundaries to apply the knowledge.

### 4.5 Comparison Table

Artifact: `artifact-constitutional-ai-comparison-table`
...
The sequence begins with explanation to establish vocabulary. Visual intuition follows to create a mental model of the critique-revision analogy. The interactive specification provides exploration space, preparing the learner for the exercise. The comparison table consolidates RLHF vs. CAI differences as a reference.
...
*   NV-800-C7 — Artifact Registry Specification
*   NV-800-C18 — Self-Critique and Revision Artifacts
*   NV-800-C19 — RLHF and Alignment Comparison Artifacts
*   NV-800-C20 — Guardrail and Policy Architecture
*   NV-800-C21 — Rule-Based Oversight Specification
*   NV-800-C22 — Harmlessness Taxonomy Standards
*   NV-800-C23 — Constitutional AI Canonical Framework
