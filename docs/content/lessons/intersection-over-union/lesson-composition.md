---
lesson_id: "lesson-intersection-over-union"
lesson_title: "Intersection over Union (IoU)"
canonical_status: "Draft"
topic: "Intersection over Union (IoU)"
artifact_ids:
...
# Intersection over Union (IoU) — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Intersection over Union (IoU).
...
After completing this lesson flow, the learner should understand the core concepts of Intersection over Union (IoU) and be able to reason about their practical use in object detection pipelines.

## 3. Covered Concepts

*   High-level foundations of Intersection over Union (IoU);
