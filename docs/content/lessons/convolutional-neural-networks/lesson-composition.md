---
lesson_id: "lesson-convolutional-neural-networks"
lesson_title: "Convolutional Neural Networks (CNNs)"
...
# Convolutional Neural Networks (CNNs) — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Convolutional Neural Networks (CNNs).
...
After completing this lesson flow, the learner should understand the core concepts of Convolutional Neural Networks (CNNs) and be able to reason about their practical use in Convolutional Neural Network downstream pipelines.

## 3. Covered Concepts

*   High-level foundations of Convolutional Neural Networks (CNNs);
