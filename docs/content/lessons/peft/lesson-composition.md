---
lesson_id: "lesson-peft"
lesson_title: "Parameter-Efficient Fine-Tuning (PEFT)"
...
# Parameter-Efficient Fine-Tuning (PEFT) — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about Parameter-Efficient Fine-Tuning (PEFT).
...
After completing this lesson flow, the learner should understand the core concepts of Parameter-Efficient Fine-Tuning (PEFT) and be able to reason about their practical use in model fine-tuning and adaptation pipelines.

## 3. Covered Concepts

*   High-level foundations of Parameter-Efficient Fine-Tuning (PEFT);
