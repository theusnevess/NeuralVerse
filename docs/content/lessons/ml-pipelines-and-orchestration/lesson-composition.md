...
# ML Pipelines and Orchestration — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about ML Pipelines and Orchestration.
...
After completing this lesson flow, the learner should understand the core concepts of ML Pipelines and Orchestration and be able to reason about their practical use in production AI engineering systems.

## 3. Covered Concepts

*   High-level foundations of ML Pipelines and Orchestration;
*   Practical trade-offs and engineering relevance;
*   Visual and spatial models representing these relationships.

## 4. Artifact Composition

### 4.1 Explanatory Text

Artifact: `artifact-ml-pipelines-and-orchestration-explanatory-text`
Role: Introduces the core vocabulary, defining terminology and parameters.

### 4.2 Visual Intuition

Artifact: `artifact-ml-pipelines-and-orchestration-visual-intuition`
Role: Provides a spatial analogy or visualization to build a strong mental model.

### 4.3 Interactive Visualization

Artifact: `artifact-ml-pipelines-and-orchestration-interactive-visualization`
Role: Outlines an interactive spec where variables can be adjusted.

### 4.4 Exercise

Artifact: `artifact-ml-pipelines-and-orchestration-exercise`
Role: Practice reasoning about algorithms or values to apply the knowledge.

### 4.5 Comparison Table

Artifact: `artifact-ml-pipelines-and-orchestration-comparison-table`
