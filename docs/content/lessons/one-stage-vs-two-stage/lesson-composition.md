---
lesson_id: "lesson-one-stage-vs-two-stage"
lesson_title: "One-Stage vs Two-Stage Detectors"
canonical_status: "Draft"
topic: "One-Stage vs Two-Stage Detectors"
artifact_ids:
...
# One-Stage vs Two-Stage Detectors — Lesson Composition

## 1. Purpose

This lesson orchestrates reusable Learning Artifacts into a coherent learning experience about One-Stage vs Two-Stage Detectors.
...
After completing this lesson flow, the learner should understand the core concepts of One-Stage vs Two-Stage Detectors and be able to reason about their practical use in object detection pipelines.

## 3. Covered Concepts

*   High-level foundations of One-Stage vs Two-Stage Detectors;
