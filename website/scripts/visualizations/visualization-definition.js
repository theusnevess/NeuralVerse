  ...
  const definitions = [
    {
      ...
      summary: 'Explore how slope controls direction and intercept shifts the line vertically.',
    ...
    },
    {
      ...
      summary: 'Observe how coefficients shape the parabola — vertex, concavity, and roots change together.',
      category: 'mathematics',
    ...
    },
    {
      ...
      summary: 'Watch the S-curve transition from low to high activation — steepness controls the sharpness.',
      category: 'mathematics',
    ...
    },
    {
      ...
      title: 'ReLU Function',
      slug: 'relu-function',
      summary: 'See how ReLU activates — zero below threshold, linear growth above.',
    ...
    },
    {
      ...
      summary: 'See how raw scores transform into probabilities — the largest input dominates.',
      category: 'deep-learning',
      concepts: ['softmax'],
    ...
    },
    {
      ...
      summary: 'Watch optimization converge — learning rate controls how aggressively loss decreases.',
    ...
    },
    {
      ...
      summary: 'Observe how attention weights distribute focus across tokens — temperature controls sharpness.',
    ...
    },
    {
      ...
      summary: 'Explore the bell curve — 68% of data falls within one standard deviation of the mean.',
      category: 'probability',
